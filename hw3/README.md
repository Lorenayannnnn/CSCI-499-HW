This project implements a LSTM encoder-decoder model, encoder-decoder global soft attention, and an additional encoder using pretrained BERT (bert-base-uncased).
